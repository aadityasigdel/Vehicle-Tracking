...
export default function MapComponent() {
  ...
  const selectedRider = apidata.find(rider => rider.riderId === selectedRiderId);
   ...
   useEffect(() => {
    ...
    // Do nothing if selectedRiderId is null — keep current center
  }, [selectedRiderId, apidata]);
...
return (
  <div className=" overflow-hidden border-2  border-gray-700 rounded-2xl">
    {/* Title Header */}
    <header className="bg-white text-black border-b-2  p-4 font-bold text-xl text-center  shadow-md">
    ...
    <div className="flex flex-grow">
      ...
      <div className="w-[300px] bg-gray-100 p-4 overflow-y-auto border-r-2 border-gray-400 h-[85vh]">
